...
public class LateSearchView2 extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LateSearchView2 frame = new LateSearchView2();
		...
		gl_panel_1.setHorizontalGroup(
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(calendarComboBox, GroupLayout.PREFERRED_SIZE, 266, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
			...
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
						.addComponent(calendarComboBox, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 27, Short.MAX_VALUE)
	 ...
	 * 学生信息查询
	 */
	private void getInfoByDate() {
		// TODO Auto-generated method stub
		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
		this.fillTable(format.format(this.calendarComboBox.getCalendar().getTime()));
	}
