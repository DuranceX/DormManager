...
public class PassUpdateView extends JInternalFrame {
	...
	public PassUpdateView() {
		...
		this.UserNameText.setText(LoginView.getLogin_username());
	}
	/**修改密码
	 * 
	 * @param e
	...
	private void updatePassActionPerfored(ActionEvent e) {
		...
		if(!old_password.equals(LoginView.getLogin_password())) {
...
//			System.out.println(LoginView.getLogin_id()+" "+LoginView.getLogin_username()+" "+new_password+" "+LoginView.getIdentity());
			User user = new User(LoginView.getLogin_id(),LoginView.getLogin_username(),new_password,LoginView.getIdentity());
